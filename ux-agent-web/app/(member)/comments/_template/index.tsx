...
import { DataGrid, Dialog, IconButton, TextLink, Typography } from '@moneyforward/mfui-components';
        ...
        <Dialog open={openDialog} title={selectedComment.name} onClose={handleDialogClose}>
          <div className={styles.dialogBody}>
            ...
            <div className={styles.dialogFooter}>
              <Document />
              <TextLink href={`/posts/${selectedComment.postId.toString()}`} customLinkComponent={Link}>
                View Post
              </TextLink>
            </div>
          </div>
