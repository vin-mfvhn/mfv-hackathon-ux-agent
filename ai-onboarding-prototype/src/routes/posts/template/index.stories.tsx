  ...
  args: {
    posts: [
      ...
      },
      {
        id: 2,
        userId: 2,
        title: "Paul McCartney's Solo Career",
        body: 'After The Beatles, Paul McCartney had a successful solo career and formed the band Wings.',
      },
      {
        id: 3,
        userId: 3,
        title: "George Harrison's Influence",
        body: "George Harrison was known for his spiritual influence and his contributions to The Beatles' music.",
      },
      {
        id: 4,
        userId: 4,
        title: "Ringo Starr's Drumming Style",
        body: "Ringo Starr's unique drumming style was a key element of The Beatles' sound.",
      },
      {
        id: 5,
        userId: 5,
        title: "The Beatles' Legacy",
        body: 'The Beatles are considered one of the greatest bands of all time, with a lasting legacy in music and culture.',
      },
    ],
    users: [
      {
